...
swapoff -a
yum update -y && yum install -y kubelet kubeadm kubectl telnet nfs-utils firewalld yum-utils timedatectl epel-release git curl unzip wget yum-utils device-mapper-persistent-data lvm2 docker
